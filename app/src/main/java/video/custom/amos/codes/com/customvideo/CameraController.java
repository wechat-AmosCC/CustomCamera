 ...
 * @Package: meterbox.scope380.cem.main
 * @ClassName: CameraController
 * @Description: java类作用描述
 * @Author: Amos
 * @CreateDate: 2019/12/4 10:42
 * @UpdateUser: 更新者：
 * @UpdateDate: 2019/12/4 10:42
 * @UpdateRemark: 更新说明：
 * @Version: 1.0
 */
...
private static class ClassHolder {
    ...
    private String getVideoFilePath() {
        ...
        return getFolderPath() + "/" +"video/"+ System.currentTimeMillis() + ".mp4";
    }
    ...
    private void lockFocus() {
        ...
        //创建文件
        mFile = new File(getFolderPath() + "/"+"image/" + getNowDate() + ".jpg");
        try {
